...
// add_action('wp_ajax_get_acf_fields', 'gc_get_fields_for_group');
// add_action('wp_ajax_nopriv_get_acf_fields', 'gc_get_fields_for_group');

// function gc_get_fields_for_group() {
...
add_action('wp_ajax_gc_get_fields_for_group', 'gc_get_fields_for_group');
add_action('wp_ajax_nopriv_gc_get_fields_for_group', 'gc_get_fields_for_group');
...
// // Add AJAX action for fetching ACF fields
...
//     $field_group_key = $_POST['field_group'];
//     $fields = acf_get_fields($field_group_key);

//     $options = '';
//     foreach ($fields as $field) {
//         $options .= '<option value="' . $field['key'] . '">' . $field['label'] . '</option>';
//     }
